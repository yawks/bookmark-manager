...
class BookmarkMapper extends QBMapper {
    ...
    public function __construct(IDBConnection $db) {
        parent::__construct($db, 'bookmarks_bookmarks', Bookmark::class);
    }
    ...
    public function setTags(int $bookmarkId, array $tagIds): void {
        ...
        $qbDelete->delete('bookmarks_bookmarks_tags')
        ...
        foreach ($tagIds as $tagId) {
            ...
            $qbInsert->insert('bookmarks_bookmarks_tags')
               ->values([
